 ...
 * ```
 * ...
 * echo $form->field($model, 'image')->widget('maxdancepro\image\Widget');
 * ...
 * ```
 */
class Widget extends InputWidget
{
    ...
    {
        if (!isset(Yii::$app->i18n->translations['maxdancepro/image']) && !isset(Yii::$app->i18n->translations['maxdancepro/*'])) {
            Yii::$app->i18n->translations['maxdancepro/image'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'basePath' => '@maxdancepro/image/messages',
                'fileMap' => [
                    'maxdancepro/image' => 'image.php'
                ],
